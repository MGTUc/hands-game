export class DirectedGraph {
    ...
    constructor(root) {
        this.vertices = {
            [root.position + String(root.computerturn)]: root,
        };
    ...
    addVertex(...vertices) {
        for (let vertex of vertices.flat()) {
            this.vertices[vertex.position + String(vertex.computerturn)] =
                vertex;
        }
    }
}
...
export class Vertex {
    ...
    /**
     *
     * @param {String} position represents the position eg, 1111 1112
